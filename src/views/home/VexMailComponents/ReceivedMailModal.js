...
const ReceivedMailModal = ({ setModalOpenState, activeItem }) => {
  // console.log("---------------------------------------");
...
const BackComponent = () =>{
    ...
    <View> 
          <Text style={{ color: "#00AA9F", fontSize: 15 }}>VexMail Gelen</Text>
...
console.log("testttttttttttttttt")
 // console.log(userDetail.userdetail.mail_imza_id);
  return (
...
{/* <Image style={{ height:95, width: 222, marginTop:20, marginLeft:13,  }} source={Kartvizit} resizeMode="contain" /> */}
 {/* <Signatures  tempateId={userDetail?.userdetail.mail_imza_id}  userdetail={userDetail} />  */}
</View>
        </ScrollView>
...
export default ReceivedMailModal;
