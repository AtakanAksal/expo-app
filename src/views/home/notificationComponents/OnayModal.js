...
const OnayModal = ({setOpenOnayModal,  thanksActive, setThanksActive}) => {
  
const [thankVerified, setThankVerified] = useState(false)

const closeModal = () =>{
  setOpenOnayModal(false)
...
return(
    <View style={styles.frame}>
     ...
     {thanksActive ?  <Text style={{color:'#6C757D', fontSize:12}}>Teşekkür İşlemi Başarılı</Text>:  <Text style={{color:'#6C757D', fontSize:12}}>İşlem Başarılı</Text>}  
        </View>
