...
const Gelirler = ({ nav, item, setSelectedComponent }) => {
    return (
      <View
        style={
      ...
      >
        <View style={styles.textRow}>
          <Text style={styles.textComman}>Gelir Modulü</Text>
          <Text style={styles.textComman}>
           Statik Veri
          </Text>
        </View>
        <View style={styles.textRow}>
          <Text style={styles.textComman}>Sipariş Türü</Text>
          <Text style={styles.textComman}>
          Statik Veri
          </Text>
        </View>
        <View style={styles.textRow}>
          <Text style={styles.textComman}>Sipariş Tarihi</Text>
          <Text style={styles.textComman}>
          Statik Veri
          </Text>
        </View>
        <View style={styles.textRow}>
          <Text style={styles.textComman}>Sipariş Tutarı</Text>
          <Text style={styles.textComman}>
          Statik Veri
          </Text>
        </View>
        <View style={[styles.textRow, { borderTopWidth: 0.5 }]}>
          <Text style={styles.textComman}>Sipariş Kuru</Text>
          <Text style={styles.textComman}>
          Statik Veri
          </Text>
        </View>
        ...
        <View style={styles.textRow}>
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            <TouchableOpacity
              style={styles.bildirimCardView}
              onPress={() => setSelectedComponent(8)}
            >
              <Image
                style={styles.bildirimItemImg}
